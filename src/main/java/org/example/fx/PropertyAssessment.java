...
public class PropertyAssessment implements Comparable<PropertyAssessment> {
    ...
    public PropertyAssessment(String[] csvRow) {
        ...
        // Add coordinates - assuming indices 16 and 17 based on Edmonton Open Data
        this.lat = csvRow.length > 16 ? parseDoubleSafe(csvRow[16]) : 0.0;
        this.lon = csvRow.length > 17 ? parseDoubleSafe(csvRow[17]) : 0.0;
